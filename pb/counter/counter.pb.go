...
func (x *CounterRequest) GetNum() int64 {
	if x != nil {
		return x.Num
	}
	return 0
...
func (x *CounterResponse) GetResult() int64 {
	if x != nil {
		return x.Result
	}
	return 0
...
var file_proto_counter_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x22, 0x0a, 0x0e, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x6e, 0x75, 0x6d, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x6e, 0x75, 0x6d, 0x22, 0x29, 0x0a, 0x0f, 0x43, 0x6f, 0x75,
	...
	0x73, 0x75, 0x6c, 0x74, 0x32, 0x42, 0x0a, 0x0e, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x30, 0x0a, 0x07, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x65,
	0x72, 0x12, 0x0f, 0x2e, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x10, 0x2e, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x18, 0x5a, 0x16, 0x2e, 0x2f, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x65, 0x72, 0x3b, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x70, 0x72, 0x6f,
...
var file_proto_counter_proto_goTypes = []interface{}{
	...
	(*CounterResponse)(nil), // 1: CounterResponse
}
var file_proto_counter_proto_depIdxs = []int32{
	0, // 0: CounterService.Counter:input_type -> CounterRequest
	1, // 1: CounterService.Counter:output_type -> CounterResponse
...
type CounterServiceClient interface {
	Counter(ctx context.Context, in *CounterRequest, opts ...grpc.CallOption) (CounterService_CounterClient, error)
}
...
func (c *counterServiceClient) Counter(ctx context.Context, in *CounterRequest, opts ...grpc.CallOption) (CounterService_CounterClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CounterService_serviceDesc.Streams[0], "/CounterService/Counter", opts...)
	if err != nil {
		return nil, err
	}
	x := &counterServiceCounterClient{stream}
...
type CounterService_CounterClient interface {
	Recv() (*CounterResponse, error)
	grpc.ClientStream
}

type counterServiceCounterClient struct {
	grpc.ClientStream
}

func (x *counterServiceCounterClient) Recv() (*CounterResponse, error) {
...
type CounterServiceServer interface {
	Counter(*CounterRequest, CounterService_CounterServer) error
}
...
func (*UnimplementedCounterServiceServer) Counter(*CounterRequest, CounterService_CounterServer) error {
...
func _CounterService_Counter_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(CounterRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(CounterServiceServer).Counter(m, &counterServiceCounterServer{stream})
}

type CounterService_CounterServer interface {
	Send(*CounterResponse) error
	grpc.ServerStream
}

type counterServiceCounterServer struct {
	grpc.ServerStream
}

func (x *counterServiceCounterServer) Send(m *CounterResponse) error {
